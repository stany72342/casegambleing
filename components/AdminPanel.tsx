...
export const AdminPanel: React.FC<AdminPanelProps> = (props) => {
  ...
  const renderDashboard = () => (
      <div className="space-y-6">
          ...
          <div className="bg-slate-900 p-6 rounded-xl border border-slate-800 flex flex-col gap-4">
              <h3 className="font-bold text-white flex items-center gap-2"><Radio size={16} className="text-blue-400" /> System Broadcast (MOTD)</h3>
              <div className="flex gap-2">
                  ...
                  />
                  <button 
                      onClick={() => { props.onSetMotd(broadcastMsg); setBroadcastMsg(''); alert('Broadcast Sent!'); }}
  ...
  // Compact renderers for other sections
  ...
  const renderEconomy = () => (
       <div className="space-y-6">
            <div className="bg-slate-900 p-6 rounded-xl border border-slate-800">
                <h3 className="font-bold text-white mb-4"><Gift className="inline mr-2 text-pink-400" /> Mass Actions</h3>
                <div className="flex gap-4">
                    <button onClick={() => props.massGift(10000)} className="px-4 py-2 bg-pink-600 text-white rounded font-bold">Gift All 10k Coins</button>
                    <button onClick={() => props.onCreatePromo('FREE10K', 10000, 1000)} className="px-4 py-2 bg-purple-600 text-white rounded font-bold">Create Code 'FREE10K'</button>
                </div>
            </div>
       </div>
  );

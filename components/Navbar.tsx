...
import { LayoutDashboard, Package, Dna, Coins, Menu, X, Trophy, ShoppingBag, LogOut, User, Gavel, ArrowRightLeft, Crown, TrendingUp, BookOpen, Terminal, Mail, Bell, Dice5 } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({ currentTab, setTab, gameState, onLogout }) => {
  ...
  const navItems = [
    ...
    { id: 'auction', label: 'Auction', icon: Gavel, disabled: !gameState.config.featureToggles.auction },
    { id: 'trade', label: 'Trade', icon: ArrowRightLeft, disabled: !gameState.config.featureToggles.trading },
